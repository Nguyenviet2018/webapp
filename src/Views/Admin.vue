...
const fetchUsers = async () => {
  try {
	//const res = await axios.get('http://192.168.0.134:3002/users', {
...
const addUser = async () => {
  try {
    //await axios.post('http://192.168.0.134:3002/admin/add-user', newUser.value, {
...
const deleteUser = async (id) => {
  ...
  try {
	//await axios.delete(`http://192.168.0.134:3002/users/${id}`, {
